...
export default function PageComponent({charactersPage, allPokemons, page}) { //me los traigo como props del otro componente
    ...
    for(let i=0; i <= Math.ceil(allPokemons/charactersPage); i++) { //voy a tomar el número redondeado de lo que resulta de dividir todoa los personajes por los personajes por página que quiero
        pageNumbers.push(i + 1) //voy a pushear el resultado de lo anterior en pageNumbers
    };
    console.log("NUMBEEEEEEEEERS",page)
